package com.willlopes.ascension;
...
public class MainActivity extends Activity {
    ...
    static class GameView extends View {
        ...
        static class Enemy{float x,y;int hp,maxHp;boolean boss;long lastHit,lastHitPlayer;Enemy(float x,float y,boolean b){this.x=x;this.y=y;boss=b;maxHp=b?500:70;hp=maxHp;}}
